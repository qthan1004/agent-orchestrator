...
flowchart LR
  ...
  mcp_server_context["📄 mcp-server/context"]
  mcp_server_plan_watcher["📄 mcp-server/plan-watcher"]
  mcp_server_recovery["📄 mcp-server/recovery"]
  ...
  worker_dispatch_loop["📄 worker/dispatch-loop"]
  task_index["📄 task/index"]
  mcp_server_server["📄 mcp-server/server"]
  mcp_server_tools["📄 mcp-server/tools"]
  mcp_server_task_queue["📄 mcp-server/task-queue"]
  scheduler_index["📄 scheduler/index"]
  mcp_server_tools_scan_workspace["📄 mcp-server/tools/scan-workspace"]
  mcp_server_tools_session_checkpoint["📄 mcp-server/tools/session-checkpoint"]
  server_tools_task_submitter["📄 server-tools/task-submitter"]
  server_tools_workspace_connector["📄 server-tools/workspace-connector"]
  ...
  index --> models_index
  mcp_server_context --> mcp_server_plan_watcher
  mcp_server_context --> mcp_server_recovery
  mcp_server_context --> mcp_server_state_manager
  mcp_server_index --> infra_index
  mcp_server_index --> mcp_server_context
  mcp_server_index --> mcp_server_plan_watcher
  mcp_server_index --> mcp_server_recovery
  mcp_server_index --> mcp_server_state_manager
  mcp_server_index --> mcp_server_transport
  mcp_server_index --> models_index
  mcp_server_index --> visibility_index
  mcp_server_index --> worker_dispatch_loop
  mcp_server_plan_watcher --> mcp_server_state_manager
  mcp_server_plan_watcher --> models_index
  mcp_server_recovery --> mcp_server_state_manager
  mcp_server_recovery --> models_index
  mcp_server_recovery --> task_index
  mcp_server_server --> mcp_server_context
  mcp_server_server --> mcp_server_tools
  mcp_server_state_manager --> mcp_server_task_queue
  mcp_server_state_manager --> models_index
  mcp_server_state_manager --> task_index
  mcp_server_task_queue --> models_index
  mcp_server_task_queue --> scheduler_index
  mcp_server_task_queue --> task_index
  mcp_server_tools --> mcp_server_context
  mcp_server_tools --> mcp_server_tools_scan_workspace
  mcp_server_tools --> mcp_server_tools_session_checkpoint
  mcp_server_tools --> server_tools_task_submitter
  mcp_server_tools --> server_tools_workspace_connector
  mcp_server_tools --> task_index
  mcp_server_transport --> mcp_server_context
  mcp_server_transport --> mcp_server_server
  ...
  server_tools_task_submitter --> mcp_server_context
  worker_dispatch_loop --> infra_index
  worker_dispatch_loop --> mcp_server_state_manager
  worker_dispatch_loop --> mcp_server_task_queue
  worker_dispatch_loop --> runtime_adapters_ollama_index
  worker_dispatch_loop --> runtime_index
  worker_dispatch_loop --> scheduler_index
```
