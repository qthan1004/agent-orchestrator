...
## Done Criteria
- [x] `AppConfig` có `runtimeRoot: string`
- [x] `WorkspaceConfig` interface tách ra
- [x] `loadConfig({ runtimeRoot })` resolve đúng paths
- [x] Fallback backward compat khi không set `runtimeRoot`
