...
## Done Criteria
- [x] Quality profile: 1 worker, 9B model, 32K ctx
- [x] Throughput profile: 2 workers, 4B model, 16K ctx
- [x] VRAM check logs warning if insufficient
- [x] Model names configurable via env vars
