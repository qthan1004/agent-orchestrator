...
## Done Criteria
- [x] Implements `LLMAdapter` interface
- [x] Calls Gemini REST API with tool definitions
- [x] Parses Gemini function_calling responses correctly
- [x] Token usage tracking from `usageMetadata`
- [x] API key from `GEMINI_API_KEY` env var
